...
function stopDebugging(manifestPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const diskManifestDir = (0, shared_1.getDiskManifestDir)(false /* create */);
            if (fs_1.default.existsSync(diskManifestDir)) {
                fs_1.default.rmSync(diskManifestDir, { recursive: true, force: true });
            }
            // unregister
            try {
